...
class SCMoreViewController: UIViewController {
    private let titleInfoArray = [
        ...
        ["title": "Current country code: ", "iconName": "btn_region", "content":"Select your country code for displaying regional news headlines."],
...
extension SCMoreViewController: SCMoreRegionControllerDelegate{
    func updatePreferredRegion(controller: SCMoreRegionController) {
        tableView.reloadRows(at: [IndexPath(item: 3, section: 0)], with: UITableView.RowAnimation.automatic)
    }
}
